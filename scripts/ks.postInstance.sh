#!/bin/bash
# Kuss, 17.08.2020
# Aufruf z.B.: ./ks.postInstance.sh instance/InstanceSample.json
...
# echo "TOKEN=$TOKEN"
instanceDatei=$1
curl -s -S -D - -X POST -H "$TOKEN" -H "X-Okapi-Tenant: diku" -H "Content-type: application/json; charset=utf-8" -H "Accept: application/json" -d \@$instanceDatei $OKAPI/inventory/instances
